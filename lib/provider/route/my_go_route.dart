...
class MyGoRoute extends GoRoute {
  MyGoRoute(
    ...
    GoRouterRedirect? redirect,
          ...
          builder: _builder(read, builder),
        );
}

RouteBuilder _builder(Reader read, RouteBuilder? builder) {
  if (builder == null) {
        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, child) =>
                ref.watch(loadingProvider) ? child! : const SizedBox.shrink(),
